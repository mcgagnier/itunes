angular.module('itunes').service('itunesService', function($http, $q){
  ...
  this.getMusic = function(artist) {
    ...
    // Go to the next step in the README (Tie in your controller).
    // You will come back to these instructions shortly.
    //
    // You need to sort the data you get back from the itunes API
